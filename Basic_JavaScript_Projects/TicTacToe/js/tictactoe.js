...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        audio('media/zapsplat_pop_place.mp3');
...
function checkWinConditions() {
    ...
    //squares are selected, the code executes.
        ...
        audio('media/zapsplat_bubble_tie.mp3');
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //This line accessess our html element.
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //This line indicates where the end of the a line's x axis is.
        x2 = coordX2,
    ...
    audio('media/zapsplat_fantasy_magic_win.mp3');
